...
cellpadding="5">
	<tr><th>제 목</th><td><input type="text" name="q_title"></td></tr>
	<tr><th>작성자</th>
	<td><input type="text" name="q_writer" readonly value="${ sessionScope.loginMember.userid }"></td></tr>
	<tr><th>첨부파일</th><td><input type="file" name="upfile"></td></tr>
	<tr><th>내 용</th><td><textarea rows="5" cols="50" name="q_content"></textarea></td></tr>
	<tr><th colspan="2">
